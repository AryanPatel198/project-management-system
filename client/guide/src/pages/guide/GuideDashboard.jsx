          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-200/80 mt-1 text-sm">Welcome back, Dr. Sarah Johnson! Ready to inspire today?</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:block font-semibold">Dr. Sarah Johnson</span>
                </button>
